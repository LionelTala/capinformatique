...
import { ArrowLeftIcon, DocumentIcon, PhotoIcon, PlusIcon, VideoCameraIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
function Create({ formations }) {
	...
	const getFileIcon = (file) => {
		...
		if (file.type === "application/pdf") return /* @__PURE__ */ jsx(DocumentIcon, { className: "w-5 h-5" });
		return /* @__PURE__ */ jsx(DocumentIcon, { className: "w-5 h-5" });
	};
	const handleSubmit = (e) => {
		e.preventDefault();
		post("/admin/cours", { forceFormData: true });
	};
...
//# sourceMappingURL=Create-CYc-Gu5t.js.map