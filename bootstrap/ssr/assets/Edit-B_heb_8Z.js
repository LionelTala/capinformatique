...
function Edit({ evaluation, formations }) {
	var _evaluation$vague_id, _evaluation$certifica, _evaluation$coefficie;
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		put(`/admin/evaluations/${evaluation.id}`, { forceFormData: true });
	};
...
//# sourceMappingURL=Edit-B_heb_8Z.js.map