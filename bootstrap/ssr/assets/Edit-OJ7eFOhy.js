...
import { ArrowLeftIcon, CalendarIcon, DocumentIcon, PencilSquareIcon, PlusIcon, UserGroupIcon, UserIcon, XMarkIcon } from "@heroicons/react/24/outline";
//#region resources/js/Pages/Admin/Evaluations/Edit.tsx
function Edit({ evaluation, formations }) {
	var _evaluation$formation, _evaluation$vague_id, _evaluation$certifica, _evaluation$student_i, _evaluation$tranche_r, _evaluation$coefficie;
	...
	const { data, setData, processing, errors } = useForm({
		...
		formation_id: ((_evaluation$formation = evaluation.formation_id) === null || _evaluation$formation === void 0 ? void 0 : _evaluation$formation.toString()) || "",
		type_destinataire: initialTypeDestinataire || "",
		vague_id: ((_evaluation$vague_id = evaluation.vague_id) === null || _evaluation$vague_id === void 0 ? void 0 : _evaluation$vague_id.toString()) || "",
		certification_id: ((_evaluation$certifica = evaluation.certification_id) === null || _evaluation$certifica === void 0 ? void 0 : _evaluation$certifica.toString()) || "",
		student_id: ((_evaluation$student_i = evaluation.student_id) === null || _evaluation$student_i === void 0 ? void 0 : _evaluation$student_i.toString()) || "",
		tranche_requise_id: ((_evaluation$tranche_r = evaluation.tranche_requise_id) === null || _evaluation$tranche_r === void 0 ? void 0 : _evaluation$tranche_r.toString()) || "",
		date: evaluation.date || "",
		coefficient: ((_evaluation$coefficie = evaluation.coefficient) === null || _evaluation$coefficie === void 0 ? void 0 : _evaluation$coefficie.toString()) || "1",
	...
	useEffect(() => {
		if (data.formation_id && data.type_destinataire === "vague") {
			...
			fetch(`/admin/evaluations/vagues/${data.formation_id}`).then((res) => {
				...
				if (evaluation.vague_id && list.some((v) => v.id === evaluation.vague_id)) setData("vague_id", evaluation.vague_id.toString());
			}).catch(() => {
				setVagues([]);
				setLoadingVagues(false);
			});
	...
	useEffect(() => {
		if (data.formation_id && data.type_destinataire === "certification") {
			...
			fetch(`/admin/evaluations/certifications/${data.formation_id}`).then((res) => {
				if (!res.ok) throw new Error(`HTTP ${res.status}`);
				return res.json();
			}).then((data) => {
				const list = Array.isArray(data) ? data : [];
				...
				if (evaluation.certification_id && list.some((c) => c.id === evaluation.certification_id)) setData("certification_id", evaluation.certification_id.toString());
			}).catch(() => {
				setCertifications([]);
				setLoadingCertifications(false);
			});
	...
	useEffect(() => {
		if (data.formation_id) {
			...
			fetch(`/admin/evaluations/tranches/${data.formation_id}`).then((res) => {
				if (!res.ok) throw new Error(`HTTP ${res.status}`);
				return res.json();
			}).then((data) => {
				const list = Array.isArray(data) ? data : [];
				...
				if (evaluation.tranche_requise_id && list.some((t) => t.id === evaluation.tranche_requise_id)) setData("tranche_requise_id", evaluation.tranche_requise_id.toString());
			}).catch(() => {
				setTranches([]);
				setLoadingTranches(false);
			});
	...
	useEffect(() => {
		if (data.certification_id && data.type_destinataire === "certification") {
			...
			fetch(`/admin/evaluations/students-by-certification/${data.certification_id}`).then((res) => {
				if (!res.ok) throw new Error(`HTTP ${res.status}`);
				return res.json();
			}).then((data) => {
				const list = Array.isArray(data) ? data : [];
				...
				if (evaluation.student_id && list.some((s) => s.id === evaluation.student_id)) setData("student_id", evaluation.student_id.toString());
			}).catch(() => {
				setStudents([]);
				setLoadingStudents(false);
			});
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Head, { title: "Modifier l'évaluation - Admin" }), /* @__PURE__ */ jsx(AdminLayout, {
				...
				children: /* @__PURE__ */ jsxs("form", {
					...
					children: [
						...
						data.type_destinataire === "vague" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							/* @__PURE__ */ jsx("p", {
								className: "text-xs text-gray-400 mt-1",
								children: "Les étudiants devront avoir payé cette tranche pour accéder à l'évaluation"
							}),
						...
						data.type_destinataire === "certification" && /* @__PURE__ */ jsxs(Fragment, { children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									children: "Les étudiants en certification ont accès à toutes les évaluations sans restriction de tranche."
								})]
							})
						] }),
						/* @__PURE__ */ jsxs("div", {
						...
						evaluation.contenu && evaluation.contenu.length > 0 && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h3", {
								...
								children: evaluation.contenu.map((file, index) => /* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("input", {
									...
									children: "🔔 Renvoyer une notification (si non déjà envoyée)"
								})]
							})
						}),
						/* @__PURE__ */ jsx("button", {
...
//# sourceMappingURL=Edit-OJ7eFOhy.js.map