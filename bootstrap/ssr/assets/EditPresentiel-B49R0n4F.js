...
//#region resources/js/Pages/Admin/Formations/EditPresentiel.tsx
function EditPresentiel({ formation }) {
	...
	const [abbreviation, setAbbreviation] = useState(formation.abbreviation);
	...
	const [price, setPrice] = useState(formation.price.toString());
	const [image, setImage] = useState(null);
	const [icon, setIcon] = useState(formation.icon || "");
	const [isActive, setIsActive] = useState(formation.is_active);
	const [ordre, setOrdre] = useState(formation.order || 0);
	const [couleur, setCouleur] = useState(formation.couleur || "blue");
	const [tags, setTags] = useState(formation.tags || []);
	const [debouches, setDebouches] = useState(formation.debouches || []);
	const [programme, setProgramme] = useState(formation.programme || []);
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Head, { title: "Modifier la formation présentiel" }), /* @__PURE__ */ jsx(AdminLayout, {
		title: "Modifier la formation présentiel",
				...
				children: /* @__PURE__ */ jsxs("form", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("button", {
							...
							children: processing ? "Mise à jour en cours..." : "Mettre à jour"
						})
					]
				})
			})]
...
//#endregion
export { EditPresentiel as default };

//# sourceMappingURL=EditPresentiel-B49R0n4F.js.map