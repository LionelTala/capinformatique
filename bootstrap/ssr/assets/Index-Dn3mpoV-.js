...
import { ChartBarIcon, CheckCircleIcon, ClockIcon, EyeIcon, EyeSlashIcon, PencilSquareIcon, PlusIcon, TrashIcon, XCircleIcon } from "@heroicons/react/24/outline";
//#region resources/js/Pages/Admin/Evaluations/Index.tsx
function Index({ evaluations }) {
	var _evaluations$length;
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Head, { title: "Gestion des évaluations - Admin" }), /* @__PURE__ */ jsxs(AdminLayout, {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("p", {
				...
				children: [
					(_evaluations$length = evaluations === null || evaluations === void 0 ? void 0 : evaluations.length) !== null && _evaluations$length !== void 0 ? _evaluations$length : 0,
					" évaluation",
					(evaluations === null || evaluations === void 0 ? void 0 : evaluations.length) !== 1 ? "s" : "",
					" au total"
				]
			}), /* @__PURE__ */ jsxs(Link, {
			...
			children: !evaluations || evaluations.length === 0 ? /* @__PURE__ */ jsxs("div", {
...
//# sourceMappingURL=Index-Dn3mpoV-.js.map