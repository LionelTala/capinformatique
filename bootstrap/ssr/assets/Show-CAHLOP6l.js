...
import { ArrowLeftIcon, CalendarIcon, ChartBarIcon, CheckCircleIcon, ClockIcon, DocumentIcon, ShieldCheckIcon, UserGroupIcon, UserIcon, UsersIcon } from "@heroicons/react/24/outline";
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("span", {
											className: `inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${evaluation.mode_envoi === "individuel" ? "bg-purple-100 text-purple-700" : "bg-blue-100 text-blue-700"}`,
											children: [evaluation.mode_envoi === "individuel" ? /* @__PURE__ */ jsx(UserIcon, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(UserGroupIcon, { className: "w-4 h-4" }), evaluation.mode_envoi === "individuel" ? "Envoi individuel" : "Envoi groupe"]
										}),
										evaluation.mode_envoi === "individuel" && evaluation.student && /* @__PURE__ */ jsxs("span", {
											...
											children: [
												...
												" (",
												evaluation.student.matricule,
												")"
											]
										}),
										evaluation.tranche_requise ? /* @__PURE__ */ jsxs("span", {
											...
											children: [
												...
												/* @__PURE__ */ jsxs("span", {
													...
													children: [
														"(",
														evaluation.tranche_requise.montant.toLocaleString(),
														" FCFA)"
													]
												})
											]
									...
									children: [
										...
										/* @__PURE__ */ jsxs("span", {
											...
											children: [
												...
												" étudiant",
												evaluation.total_etudiants > 1 ? "s" : ""
											]
										}),
										/* @__PURE__ */ jsxs("span", {
											className: "flex items-center gap-1 text-gray-500",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [evaluation.mode_envoi === "individuel" ? /* @__PURE__ */ jsx("span", { children: "👤 Envoi individuel à un seul étudiant" }) : /* @__PURE__ */ jsxs("span", { children: [
						"👥 Envoi groupé à ",
						evaluation.total_etudiants,
						" étudiant",
						evaluation.total_etudiants > 1 ? "s" : ""
...
//# sourceMappingURL=Show-CAHLOP6l.js.map