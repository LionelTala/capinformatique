...
import { ArrowLeftIcon, BookOpenIcon, CheckCircleIcon, DocumentIcon, ExclamationTriangleIcon, EyeIcon, LockClosedIcon, LockOpenIcon, VideoCameraIcon } from "@heroicons/react/24/outline";
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Head, { title: `${cours.titre} - Détails du cours` }), /* @__PURE__ */ jsx(StudentLayout, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				cours.lessons && cours.lessons.length > 0 && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: cours.lessons.map((lesson, index) => /* @__PURE__ */ jsx("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												/* @__PURE__ */ jsxs("span", {
													className: "text-sm font-medium text-gray-400 w-6",
													children: [String(lesson.order || index + 1).padStart(2, "0"), "."]
												}),
												/* @__PURE__ */ jsx(Link, {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												lesson.viewed_at && /* @__PURE__ */ jsxs("span", {
													...
													children: ["Vu le ", lesson.viewed_at]
												})
											]
										})
									]
									...
									children: [/* @__PURE__ */ jsx(EyeIcon, { className: "w-4 h-4" }), "Voir"]
								})]
							})
						}, lesson.id))
					})]
...
//# sourceMappingURL=Show-Gzgj1xZ1.js.map