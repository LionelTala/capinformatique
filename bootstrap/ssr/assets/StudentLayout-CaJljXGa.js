import { n as NotificationBell, t as ToastContainer } from "./ToastContainer-H3W8-mdi.js";
import { Link, usePage } from "@inertiajs/react";
import { jsx, jsxs } from "react/jsx-runtime";
import { useState } from "react";
import { ArrowLeftOnRectangleIcon, Bars3Icon, BookOpenIcon, ChartBarIcon, ChatBubbleLeftIcon, ChevronDownIcon, ClipboardDocumentListIcon, HomeIcon, UserIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
var StudentLayout = ({ children, title = "Tableau de bord" }) => {
	...
	const discussions = [
		{
			id: 1,
			name: "Vague Janvier 2026",
			lastMessage: "Bonjour, quand aura lieu le prochain cours ?",
			unread: 2
		},
		{
			id: 2,
			name: "Vague Mars 2026",
			lastMessage: "Merci pour les cours !",
			unread: 0
		},
		{
			id: 3,
			name: "Certification Infographie",
			lastMessage: "J'ai terminé le module 3",
			unread: 1
		}
	];
	const menuItems = [
				...
				children: /* @__PURE__ */ jsxs("nav", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
                            ...
                            flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium
                            transition-colors duration-200
                            ${url.startsWith("/student/chat") ? "bg-cab-blue text-white" : "text-gray-600 hover:bg-gray-100 hover:text-cab-blue"}
                        `,
							children: [
								/* @__PURE__ */ jsx(ChatBubbleLeftIcon, { className: "w-5 h-5" }),
								/* @__PURE__ */ jsx("span", {
									className: "flex-1",
									children: "Chat"
								}),
								totalUnread > 0 && /* @__PURE__ */ jsx("span", {
									className: "text-xs font-bold bg-red-500 text-white rounded-full px-2 py-0.5",
...
//# sourceMappingURL=StudentLayout-CaJljXGa.js.map