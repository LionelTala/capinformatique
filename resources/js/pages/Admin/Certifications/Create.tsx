// resources/js/pages/Admin/Certifications/Create.tsx
...
export default function Create({ formations }: Props) {
    ...
    return (
        <>
            <Head title="Créer une certification - Admin" />

            <AdminLayout title="Créer une certification">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5" encType="multipart/form-data">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">
                                    Image de la certification (optionnelle)
                                </label>
                                ...
                                <p className="text-xs text-gray-400 mt-1">Si non renseignée, l'image de la formation sera utilisée</p>
