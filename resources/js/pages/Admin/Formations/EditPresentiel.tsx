// resources/js/pages/Admin/Formations/EditPresentiel.tsx
...
interface Props {
    formation: FormationPresentiel;
}

export default function EditPresentiel({ formation }: Props) {
    ...
    const [couleur, setCouleur] = useState<'blue' | 'red'>(formation.couleur || 'blue');

    const [tags, setTags] = useState<string[]>(formation.tags || []);
    const [debouches, setDebouches] = useState<string[]>(formation.debouches || []);
    const [programme, setProgramme] = useState<string[]>(formation.programme || []);
    ...
    return (
        <>
            <Head title="Modifier la formation présentiel" />

            <AdminLayout title="Modifier la formation présentiel">
