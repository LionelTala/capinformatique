...
* @see app/Http/Controllers/Student/CoursController.php:17
* @route '/student/cours'
*/
...
* @see app/Http/Controllers/Student/CoursController.php:97
...
* @see app/Http/Controllers/Student/CoursController.php:161
